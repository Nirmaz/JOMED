...
class Task(BaseTask):
    ...
    def __init__(self, opt: Options, *args, **kwargs):
        ...
        self.question = '<image>'
        self.question_text = 'what is the severity of diabetic retinopathy?'
        self.opt = opt
        passages_path = "/cs/labs/tomhope/nirm/atlas_data_dir/data/vqa_rad/dev_pass_pne_one_ex_pne.jsonl"
        # self.label = ['bladder', 'femur-left', 'femur-right', 'heart', 'kidney-left',
        #                  'kidney-right', 'liver', 'lung-left', 'lung-right', 'pancreas',
        #                  'spleen']
        self.label = ['0','1', '2', '3', '4', '5']
        self.targets = ['0', '1', '2', '3', '5']
        self.answers = ['0', '1', '2', '3', '5']
    ...
    def create_passage_qwen(self, passage, query):
        ...
        for batch_p_q in zip(passage, query):
            ...
            promp_closed_book = self.question_text
    ...
    def shuffle_iterator(dataset):
        ...
        min_len = min(len(_0_dicts), len(_1_dicts),len(_2_dicts),len(_3_dicts), len(_4_dicts))
